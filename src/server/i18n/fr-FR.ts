...
export let messages : IMessages = {
    ...
    you_are_unuscribed: "vous êtes désinscrit",
    you_are_unuscribed_long: "vous avez été désincrit de cette liste et ne recevrez plus d'email.",
    subscribe_again : "réinscrivez vous"
};
